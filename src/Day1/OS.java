...
public class OS {
    ...
    private int[] imgContent = new int[]{
            ...
            0X04, 0X83, 0XC8, 0X01, 0X3C, 0X00, 0X74, 0X09, 0XB4, 0X0E, 0XBB, 0X0F, 0X00, 0XCD, 0X10, 0XEB,     //0X60-0X6F
    ...
    public OS(String s) {
        ...
        for (int i = imgToByte.size(); i < 0X1400; i++) {
            imgToByte.add(0X00);
        }
        ...
        for (int i = imgToByte.size(); i < 0X168000; i++) {
            imgToByte.add(0X00);
        }
    }
